...
clean_data <- read.csv("cleanedSurveyData.csv")


plotting_data <- SpatialPoints(clean_data[, c("Longitude", "Latitude")])

#Map of DC neighborhoods from maps2.dcgis.dc.gov
dc <- readOGR("Georgetown University/Georgetown 2020-2021/Data Analysis with R/Neighborhood_Clusters.shp", "Neighborhood_Clusters")
